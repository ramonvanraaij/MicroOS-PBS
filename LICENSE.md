...
The original contributions to this repository - including the build system, deployment
and setup scripts, CI/CD workflows, Quadlet and Compose configuration, and documentation
authored by **Rámon van Raaij** (2026), together with the extensive refactoring and
modifications applied to inherited portions - are licensed under the
**Apache License, Version 2.0** (SPDX: `Apache-2.0`). The full license text is included
at the bottom of this file.

Unless you explicitly state otherwise, any contribution intentionally submitted for
inclusion in this repository shall be licensed under the Apache License, Version 2.0,
without any additional terms or conditions (per Section 5 of the license).

### 🛡️ Note on Upstream Contributions

Portions of this project originated from the repository
[ayufan/pve-backup-server-dockerfiles](https://github.com/ayufan/pve-backup-server-dockerfiles)
by **Kamil Trzciński** (2020-2025), which does not include a formal LICENSE file. The
original upstream project also includes contributions from other developers. All
original author attributions, commit histories, and contributor records remain fully
intact and visible within this repository's Git history.

Those portions remain under their respective authors' copyright. Their re-publication
here relies on the de facto public availability of those works and the apparent intent
of their authors to share with the community. The Apache License 2.0 grant in this
repository applies only to the original contributions by Rámon van Raaij. Redistributors
should seek their own clearance before incorporating those portions into commercial
products.

If you are an upstream author and you object to your work being incorporated or
redistributed here, please open an issue or contact the maintainer directly. The
maintainer will, at his sole discretion, remove the disputed portions, take the
repository private, take it down entirely, or work with you to relicense the affected
sections under terms you accept.

### ⚖️ Note on Packaged Software (AGPL-3.0)

The software built, installed, and distributed by this project - **Proxmox Backup
Server (PBS)** - is open-source software licensed under the **GNU Affero General Public
License, version 3 or (at your option) any later version** (SPDX: `AGPL-3.0-or-later`)
by **Proxmox Server Solutions GmbH**. The container images published by this project
install unmodified PBS packages from the official Proxmox APT repositories.

The complete corresponding source code for Proxmox Backup Server is available from the
official upstream repositories at **<https://git.proxmox.com/>** (in particular
[proxmox-backup](https://git.proxmox.com/?p=proxmox-backup.git;a=summary)). Users and
redistributors are responsible for ensuring that their use and distribution of the
packaged software complies with the AGPL-3.0 terms.
